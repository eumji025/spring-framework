...
public class EnableAspectJAutoProxyTests {
	...
	public static class LoggingAspect {
		...
		public void loggingBeginByAtArgs() {
			System.out.println("before aspect 1 execute");
		}
		@org.aspectj.lang.annotation.After("@args(org.springframework.context.annotation.EnableAspectJAutoProxyTests.Loggable))")
		public void loggingAfterByAtArgs() {
			System.out.println("after aspect 1 execute");
		}

		@org.aspectj.lang.annotation.Around("@args(org.springframework.context.annotation.EnableAspectJAutoProxyTests.Loggable))")
		public void loggingAroundByAtArgs(ProceedingJoinPoint pjp) throws Throwable {
			System.out.println("Around aspect 1 execute");
			pjp.proceed();
			System.out.println("Around aspect 2 execute");
		}

		@org.aspectj.lang.annotation.AfterReturning("@args(org.springframework.context.annotation.EnableAspectJAutoProxyTests.Loggable))")
		public void loggingReturnByAtArgs() {
			System.out.println("return aspect 1 execute");
		}
	}
	...
	public static class LoggingAspect2 {
		...
		@Before("@args(org.springframework.context.annotation.EnableAspectJAutoProxyTests.Loggable))")
		public void loggingBeginByAtArgs() {
			System.out.println("aspect 2 execute");
